...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Aashoo Sharma";
...
var typed = new Typed(".typing-text", {
    strings: ["Cyber Security", "Backend development", "IOT Engineer", "DevOps Engineer", "Web development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
        ...
        <div class="box tilt certificate-box">
            <div class="content">
                ...
                <div class="details">
                    ...
                    <p><strong>Skills:</strong> ${certificate.skills.join(", ")}</p>
                    <div class="btns">
                        <a href="./assets/images/certificates/${certificate.image}jpg" class="btn" target="_blank"><i class="fas fa-eye"></i> View</a>
